...
///txt test
static const char sequence_1_message[] = "Required. Path to a first sequence file.";


/// @brief message for images argument
static const char sequence_2_message[] = "Required. Path to a secend sequence file.";
...
/// @brief message resizable output flag
static const char output_1_message[] = "Required. output the results of first sequence.";

static const char output_2_message[] = "Required. output the results of second sequence.";

/// @brief Define flag for showing help message <br>
DEFINE_bool(h, false, help_message);

///2. test
DEFINE_string(i1, "", sequence_1_message);

/// @brief Define parameter for set image file <br>
/// It is a required parameter
DEFINE_string(i, "", sequence_2_message);
...
//2.
DEFINE_string(o1, "", output_1_message);
DEFINE_string(o2, "", output_2_message);
...
static void showUsage() {
    ...
    std::cout << "    -i1 \"<path>\"                  " << sequence_1_message << std::endl;
    
    
    std::cout << "    -i \"<path>\"                  " << sequence_2_message << std::endl;
    ...
    //2.
    std::cout << "    -o1 \"<path>\"                  " << output_1_message << std::endl;
        
    std::cout << "    -o2 \"<path>\"                  " << output_2_message << std::endl;
}
